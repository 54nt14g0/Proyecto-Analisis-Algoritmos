...
std::vector<std::vector<int>> strassen_naiv(const std::vector<std::vector<int>>& A, const std::vector<std::vector<int>>& B) {
    ...
    auto M1 = strassen_naiv(add(A11, A22), add(B11, B22));
    auto M2 = strassen_naiv(add(A21, A22), B11);
    auto M3 = strassen_naiv(A11, subtract(B12, B22));
    auto M4 = strassen_naiv(A22, subtract(B21, B11));
    auto M5 = strassen_naiv(add(A11, A12), B22);
    auto M6 = strassen_naiv(subtract(A21, A11), add(B11, B12));
    auto M7 = strassen_naiv(subtract(A12, A22), add(B21, B22));
